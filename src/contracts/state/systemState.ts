...
// The enum keeps only durable runtime control states and canonical lifecycle
// states. Transient outcomes live in ImplementationEvent.
...
// One state may admit more than one action when the runtime can recover or
// branch. This keeps the correlation explicit from the state side.
...
export const NEXT_STATE_BY_IMPLEMENTATION_EVENT = {
    ...
    [ImplementationEvent.STATE_CORRECTED_TO_NO_COMPASSROSE_DOCUMENTATION]: ImplementationState.NO_COMPASSROSE_DOCUMENTATION,
    [ImplementationEvent.STATE_CORRECTED_TO_REQUEST_PENDING]: ImplementationState.REQUEST_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_FORMALIZATION_PENDING]: ImplementationState.FORMALIZATION_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_FORMALIZED]: ImplementationState.FORMALIZED,
    [ImplementationEvent.STATE_CORRECTED_TO_TASK_PLANNING_PENDING]: ImplementationState.TASK_PLANNING_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_TASK_READY]: ImplementationState.TASK_READY,
    [ImplementationEvent.STATE_CORRECTED_TO_IMPLEMENTATION_RUNNING]: ImplementationState.IMPLEMENTATION_RUNNING,
    [ImplementationEvent.STATE_CORRECTED_TO_QUALITY_GATES_PENDING]: ImplementationState.QUALITY_GATES_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_REVIEW_PENDING]: ImplementationState.REVIEW_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_CORRECTION_PENDING]: ImplementationState.CORRECTION_PENDING,
    [ImplementationEvent.STATE_CORRECTED_TO_IMPLEMENTATION_FAILED]: ImplementationState.IMPLEMENTATION_FAILED,
