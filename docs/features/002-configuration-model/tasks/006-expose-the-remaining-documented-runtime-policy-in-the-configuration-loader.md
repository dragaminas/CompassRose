...
Add failing Vitest cases in tests/configReader.test.ts for canonical values and invalid development_policy, review_policy, quality_gates, and limits fields.
