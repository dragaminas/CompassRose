...
Recover or finish subtask implementation of `F002-T05-C1-CORRECTION-HANDOFF-C1-CORRECTION-R1-CORRECTION-1-REPAIR-HANDOFF` before allowing review or new planning.
