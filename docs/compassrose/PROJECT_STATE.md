...
- Execute correction subtask `F002-T17-C1-CORRECTION-R1` for the active feature.
...
Doctor recovery task `F002-T17-C1-DOCTOR-RECOVERY-R6` passed re-entry quality gates and was applied by the prototype orchestrator.
...
The active feature is `002-configuration-model`, and its next valid action is to execute correction subtask `F002-T17-C1-CORRECTION-R1`.
