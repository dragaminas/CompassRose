...
- Execute correction subtask `F002-T16-C1-CORRECTION-R1` for the active feature.
...
The active feature is `002-configuration-model`, and its next valid action is to execute correction subtask `F002-T16-C1-CORRECTION-R1`.
