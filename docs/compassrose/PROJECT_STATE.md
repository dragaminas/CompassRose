...
- Execute unblock task `F002-T04-C2-U1-U1-C1-C1-U1` for the active feature.
...
The active feature is `002-configuration-model`, and its next valid action is to execute unblock task `F002-T04-C2-U1-U1-C1-C1-U1` from the captured `task_ready` state.
