...
- Execute correction subtask `F002-T12-C1` for the active feature.
...
Subtask `F002-T11-C1-CORRECTION-1` was approved by the prototype orchestrator.
...
The active feature is `002-configuration-model`, and its next valid action is to execute correction subtask `F002-T12-C1`.
