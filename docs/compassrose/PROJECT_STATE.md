...
- Recover or finish implementation for `F002-T16-C1-CORRECTION-R1`.
...
The active feature is `002-configuration-model`, and subtask execution for `F002-T16-C1-CORRECTION-R1` is in progress.
