...
- Feature `002-configuration-model` now has a planned next task, `F002-T09`, ready to execute.
...
- Execute correction subtask `F002-T09-C1-CORRECTION-1` for the active feature.
...
The active feature is `002-configuration-model`, and its next valid action is to execute correction subtask `F002-T09-C1-CORRECTION-1`.
