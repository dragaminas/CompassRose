...
- Feature `002-configuration-model` now has a planned next task, `F002-T08`, ready to execute.
...
- Execute `F002-T08` for the active feature.
...
The active feature is `002-configuration-model`, and its next valid action is to execute `F002-T08`.
